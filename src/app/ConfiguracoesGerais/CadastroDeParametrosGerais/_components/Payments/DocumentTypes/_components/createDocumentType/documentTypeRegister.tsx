...
// import { type CreateDocumentTypeFormValues } from "./documentTypeRegisterFormSchema";

// type DocumentTypeRegisterProps = {
//   form: UseFormReturn<CreateDocumentTypeFormValues>;
//   onSubmit: (data: CreateDocumentTypeFormValues) => void;
// };

// export default function DocumentTypeRegister(props: DocumentTypeRegisterProps) {
//   return (
//     <Form {...props.form}>
