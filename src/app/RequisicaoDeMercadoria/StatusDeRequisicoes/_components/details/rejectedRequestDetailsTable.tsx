  ...
  return (
    <TableComponent className="gap-3 text-left">
      <TableComponent.Table>
        <TableComponent.LineTitle className="min-w-[400px] grid-cols-[0.5fr_2fr_1fr] gap-2 px-[4px] sm:min-w-[1200px] sm:gap-10">
        ...
        {props.request.requestProducts.map((product, index) => (
          <TableComponent.Line
            className={`min-w-[400px] grid-cols-[0.5fr_2fr_1fr] gap-2 px-[4px] sm:min-w-[1200px] sm:gap-10 ${
