...
import { useManageInventoriesFilters } from "./useManageInventoriesFilters";

export default function ManageInventoriesFilters() {
  const filters = useManageInventoriesFilters();
